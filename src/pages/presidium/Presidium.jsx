...
const Presidium = () => {
  ...
  const handleDetailClick = (id) => {
    // fetchData(`/presidium/${id}`).then((res) => {
  ...
  const handleEdit = (id) => {
    ...
    setNewLevel(selectedItem.jabatan);
    setOpenDrawer(true);
    setEditMode(true);
    // setEditingId(id);
  ...
  // useEffect(() => {
  //   fetchData(`/presidium?page=${page}&per_page=${itemsPerPage}`).then((res) => {
  //     setData(res.data);
                ...
                >
                  ...
                  <Grid item xs={8}>
                    <Typography
                      sx={{ fontFamily: "Poppins", fontSize: "16px" }}
                    >
                      : {AnggotaData[selectedDetail].jabatan}
                    </Typography>
                  </Grid>
                </Grid>
              </Card>
